...
// New function to send OTP emails
export const sendOTP = async (email, code, type) => {
  try {
    validateSmtpConfig(config.smtp);
    const transporter = createEmailTransporter(config.smtp);
...
// Helper function to get OTP subject based on type
const getOTPSubject = (type) => {
  const subjects = {
    'email_verification': 'Verify Your Email - TopInfo',
    'password_reset': 'Password Reset Verification - TopInfo',
    'login_verification': 'Login Verification - TopInfo',
    'account_verification': 'Account Verification - TopInfo'
  };
  return subjects[type] || 'Verification Code - TopInfo';
};


// Generate OTP email HTML
const generateOTPEmailHtml = (code, type) => {
  const typeMessages = {
    'email_verification': {
      title: 'Email Verification',
      message: 'Please use the following code to verify your email address:',
      instruction: 'Enter this code on the verification page to complete your email verification.'
    },
    'password_reset': {
      title: 'Password Reset Verification',
      message: 'Please use the following code to reset your password:',
      instruction: 'Enter this code on the password reset page to proceed with changing your password.'
    },
    'login_verification': {
      title: 'Login Verification',
      message: 'Please use the following code to complete your login:',
      instruction: 'Enter this code to verify your identity and complete the login process.'
    },
    'account_verification': {
      title: 'Account Verification',
      message: 'Please use the following code to verify your account:',
      instruction: 'Enter this code to complete your account verification.'
    }
  };

  const typeConfig = typeMessages[type] || typeMessages['email_verification'];
    ...
    <body>
      <div class="email-container">
        ...
        <div class="email-body">
          ...
          <p>${typeConfig.message}</p>
          
          <div class="otp-code">
            ${code}
          </div>
          
          <p>${typeConfig.instruction}</p>
        ...
        <div class="footer">
          © 2024 TopInfo. All rights reserved.<br>
          If you need help, contact us at support@topinfo.com
        </div>
      </div>
    </body>
    </html>
...
// Create emailService object with all email functions - moved to the end after all functions are declared
